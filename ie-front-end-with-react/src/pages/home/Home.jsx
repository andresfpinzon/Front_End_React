...
return (
    ...
    <Container>
                ...
                <Grid item xs ={12} sm={6} md={4} key={curso._id}>
                    <Card onClick={() => handleCardClick(curso)}>
                        <CardMedia
                            ...
                            style={{ boerderRadius: '50%', width: 140, height: 140, margin: 'auto'}}
                        />
                        <CardContent>
        ...
        <Snackbar open={openSnackbar} autoHideDuration={6000} onClose={handleCloseSnackbar}>
            <Alert onClose={handleCloseSnackbar} severity={errorMessage.includes('exito') ? 'succes' : 'error'} sx={{ width: '100%' }}>
                {errorMessage}
            </Alert>
        </Snackbar>
